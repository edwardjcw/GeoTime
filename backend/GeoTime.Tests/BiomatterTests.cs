...
public class BiomatterTests
{
    ...
    {
        var f = BiomatterEngine.TemperatureFactor(20, 20, 10);
    ...
    {
        var f = BiomatterEngine.TemperatureFactor(100, 20, 10);
        Assert.True(f >= 0);
    }
    ...
    {
        var f = BiomatterEngine.LightFactor(-3000);
        Assert.True(f < 1.0);
        Assert.True(f >= 0);
    }
    ...
    {
        var f = BiomatterEngine.LightFactor(-5000);
        Assert.True(f <= 0.01);
    }
    ...
    {
        var f = BiomatterEngine.ReefFactor(24, -20);
        Assert.True(f > 0.5);
    }
    ...
    {
        var p = BiomatterEngine.MarineProductivity(20, -50, 0.1);
        Assert.True(p > 0);
    }
    ...
    {
        var optimal = BiomatterEngine.MarineProductivity(20, -50, 0.1);
        var cold = BiomatterEngine.MarineProductivity(0, -50, 0.1);
    ...
    {
        var p = BiomatterEngine.CyanobacteriaProductivity(25, -50);
        Assert.True(p > 0);
    }
    ...
    {
        var p1 = BiomatterEngine.FungiProductivity(20, 0.5, 10, 0.1);
        var p2 = BiomatterEngine.FungiProductivity(20, 0.5, 20, 0.1);
        Assert.True(p2 > p1);
    ...
    public void Tick_ReefCells_IncrementHeight()
    {
        ...
        var initialHeight = state.HeightMap[0];
        engine.Initialize(state, atmo, strat);
        var result = engine.Tick(-4000, 1.0);
